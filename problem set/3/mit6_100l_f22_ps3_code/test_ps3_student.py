...
if __name__ == '__main__':
    ...
    suite.addTest(test_loader.loadTestsFromTestCase(TestPrepData))
    suite.addTest(test_loader.loadTestsFromTestCase(TestWordFrequency))
    suite.addTest(test_loader.loadTestsFromTestCase(TestLetterFrequency))
    suite.addTest(test_loader.loadTestsFromTestCase(TestGetFrequentWords))
    suite.addTest(test_loader.loadTestsFromTestCase(TestSimilarity))
    suite.addTest(test_loader.loadTestsFromTestCase(TestTFIDF))
